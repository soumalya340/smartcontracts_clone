...
const LINEA_GOERLI_RPC_URL =
    process.env.LINEA_GOERLI_RPC_URL ||
    "https://linea-goerli.infura.io/v3/api-key"
const FILECOIN_CALIBARATION_RPC_URL =
    process.env.FILECOIN_CALIBARATION_RPC_URL ||
    "https://rpc.ankr.com/filecoin_testnet"
const BNB_TESTNET_RPC_URL =
    process.env.BNB_TESTNET_RPC_URL || "https://bsc-testnet.public.blastapi.io"
...
const LINEA_RPC_URL =
    process.env.LINEA_RPC_URL || "https://linea-mainnet.infura.io/v3/api-key"
const FILECOIN_RPC_URL =
    process.env.FILECOIN_RPC_URL ||
    "https://filecoin-mainnet.chainstacklabs.com/rpc/v1"
const BNB_RPC_URL =
    process.env.BNB_RPC_URL || "https://bsc.blockpi.network/v1/rpc/public"
...
const FILECOINSCAN_API_KEY =
    process.env.FILECOINSCAN_API_KEY || "filecoinscan API Key"
